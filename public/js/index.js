...
const translations = {
    ar: {
        ...
        'portfolio.subtitle': 'نماذج من مشاريعنا الناجحة التي نفخر بها',
        'portfolio.item1.title': 'منصة تجارة إلكترونية',
        'portfolio.item1.desc': 'حل متكامل للتجارة الإلكترونية',
        'portfolio.item2.title': 'نظام إدارة تعليمي',
        'portfolio.item2.desc': 'منصة تعليمية تفاعلية',
        'portfolio.item3.title': 'نظام صحي ذكي',
        'portfolio.item3.desc': 'حلول تقنية للمجال الطبي',
        'portfolio.item4.title': 'إدارة الشركات',
        'portfolio.item4.desc': 'نظام إدارة متكامل للشركات',
        ...
        'testimonials.subtitle': 'ما يقوله عملاؤنا عن خدماتنا',
        'testimonials.quote1': 'فريق Zero Big قام بتطوير موقعنا الإلكتروني بكل احترافية، النتائج كانت مذهلة.',
        'testimonials.author1': 'مدير شركة تقنية',
        'testimonials.quote2': 'تعاملنا مع Zero Big في عدة مشاريع، وكانوا دائماً عند حسن الظن.',
        'testimonials.author2': 'رائدة أعمال',
        'testimonials.quote3': 'حلولهم البرمجية ساعدتنا في تطوير أعمالنا بشكل كبير، نشكرهم على ذلك.',
        ...
        'form.timeline': 'الإطار الزمني المتوقع',
    ...
    en: {
        ...
        'nav.contact': 'Contact',
        'hero.title': 'Building the Digital Future Together',
        ...
        'portfolio.subtitle': 'Examples of our successful projects we are proud of',
        'portfolio.item1.title': 'E-Commerce Platform',
        'portfolio.item1.desc': 'Complete e-commerce solution',
        'portfolio.item2.title': 'LMS System',
        'portfolio.item2.desc': 'Interactive learning platform',
        'portfolio.item3.title': 'Smart Health System',
        'portfolio.item3.desc': 'Tech solutions for healthcare',
        'portfolio.item4.title': 'Enterprise Management',
        'portfolio.item4.desc': 'Complete business management system',
        ...
        'process.step4.title': 'Testing & Review',
        ...
        'testimonials.quote1': 'The Zero Big team developed our website with great professionalism, the results were amazing.',
        'testimonials.author1': 'Tech Company Manager',
        'testimonials.quote2': 'We worked with Zero Big on several projects, they always exceeded expectations.',
        'testimonials.author2': 'Entrepreneur',
        'testimonials.quote3': 'Their software solutions helped us grow our business significantly, we thank them for that.',
